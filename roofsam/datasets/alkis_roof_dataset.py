...
class AlkisRoofDataset(Dataset):
    def __init__(self, dataset_root, num_sampled_points=10, min_samples_threshold=10):
        ...
        self.class_to_index = {
            cls: idx for idx, cls in enumerate(sorted(set(self.classes)))
        }
    ...
    def apply_threshold_to_classes(self):
        ...
        low_freq_classes = {
            ...
            if count < self.min_samples_threshold and cls != "other"
        }
        if low_freq_classes:
    ...
    def __getitem__(self, idx):
        ...
        embedding = torch.load(embedding_path, map_location="cpu").squeeze(
            0
    ...
    def get_train_test_split(
        ...
        class_weights = torch.tensor(
            [
                ...
                for cls in sorted(class_to_index.keys())
            ],
            dtype=torch.float32,
        )
        ...
        return train_dataset, test_dataset, num_classes, index_to_class, class_weights
